  ...
  <div class="d-flex main-sidebar" style="height: 100%">
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
        ...
        <symbol id="customers" viewBox="0 0 32 94">
          <path
        ...
        <symbol id="qr-scan" viewBox="0 0 16 16">
          <path
    ...
    <div class="bottom-menu bg-light">
      ...
      <a class="menu-item" @click="showQrScanner = true" style="padding-bottom: 8px"
        ><svg width="35" height="35"><use xlink:href="#qr-scan"></use></svg>
      </a>
    ...
    <qr-scanner v-model:show="showQrScanner" @close="showQrScanner = false" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    canShowMenu(link) {
      let menuItem = headerMenuItems.find((l) => l.link === link);
      if (!menuItem) return false;

      return (
        menuItem.includedRoles.includes(this.currentUser.role) ||
        menuItem.includedRoles.includes("allRoles")
      );
    },
  },
};
