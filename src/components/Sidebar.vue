<template>
  <div class="d-flex"  style="height: 100%">
    <div class="desktop-sidebar sidebar-fixed-left" style="min-height: 100vh; height: 100vh;">
      ...
      <div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          <li v-for="link in links" :key="link.link">
            <router-link :to="link.link" class="nav-link link-dark" active-class="activee">
    ...
    <div class="bottom-menu bg-light">
      <template v-for="link in links.filter(l => mobileLinks.includes(l.link))" :key="link.link">
