...
export const CURRENCY = "auth/CURRENCY";
...
export const MUTATE_CURRENCY = "auth/MUTATE_CURRENCY";
...
export const EXPORT_FINANCE_REPORT = "stats/EXPORT_FINANCE_REPORT";
export const MUTATE_IS_LOADING_EXPORT_FINANCE_REPORT = "stats/MUTATE_IS_LOADING_EXPORT_FINANCE_REPORT";
export const IS_LOADING_EXPORT_FINANCE_REPORT = "stats/IS_LOADING_EXPORT_FINANCE_REPORT";
export const SET_IS_LOADING_EXPORT_FINANCE_REPORT = "stats/SET_IS_LOADING_EXPORT_FINANCE_REPORT";

export const EXPORT_ORDERS_BY_CUSTOMERS = "stats/EXPORT_ORDERS_BY_CUSTOMERS";
export const MUTATE_IS_LOADING_EXPORT_ORDERS_BY_CUSTOMERS = "stats/MUTATE_IS_LOADING_EXPORT_ORDERS_BY_CUSTOMERS";
export const IS_LOADING_EXPORT_ORDERS_BY_CUSTOMERS = "stats/IS_LOADING_EXPORT_ORDERS_BY_CUSTOMERS";
export const SET_IS_LOADING_EXPORT_ORDERS_BY_CUSTOMERS = "stats/SET_IS_LOADING_EXPORT_ORDERS_BY_CUSTOMERS";

export const LOAD_FINANCE_REPORT = "stats/LOAD_FINANCE_REPORT";
export const FINANCE_REPORT = "stats/FINANCE_REPORT";
export const MUTATE_FINANCE_REPORT = "stats/MUTATE_FINANCE_REPORT";
export const IS_LOADING_FINANCE_REPORT = "stats/IS_LOADING_FINANCE_REPORT";
export const MUTATE_IS_LOADING_FINANCE_REPORT = "stats/MUTATE_IS_LOADING_FINANCE_REPORT";
...
// Журнал платежей заказчиков
export const LOAD_PAYMENT_JOURNALS = "paymentJournal/LOAD_PAYMENT_JOURNALS";
export const MUTATE_PAYMENT_JOURNALS = "paymentJournal/MUTATE_PAYMENT_JOURNALS";
export const PAYMENT_JOURNALS = "paymentJournal/PAYMENT_JOURNALS";
export const LOAD_PAYMENT_JOURNAL = "paymentJournal/LOAD_PAYMENT_JOURNAL";
export const PAYMENT_JOURNAL = "paymentJournal/PAYMENT_JOURNAL";
export const MUTATE_PAYMENT_JOURNAL = "paymentJournal/MUTATE_PAYMENT_JOURNAL";
export const SAVE_PAYMENT_JOURNAL = "paymentJournal/SAVE_PAYMENT_JOURNAL";
export const UPDATE_PAYMENT_JOURNAL = "paymentJournal/UPDATE_PAYMENT_JOURNAL";
export const DELETE_PAYMENT_JOURNAL = "paymentJournal/DELETE_PAYMENT_JOURNAL";
export const IS_PAYMENT_JOURNALS_LOADING = "paymentJournal/IS_PAYMENT_JOURNALS_LOADING";
export const MUTATE_IS_PAYMENT_JOURNALS_LOADING = "paymentJournal/MUTATE_IS_PAYMENT_JOURNALS_LOADING";
export const SET_IS_PAYMENT_JOURNALS_LOADING = "paymentJournal/SET_IS_PAYMENT_JOURNALS_LOADING";

// Журнал выплат зарплаты
export const SALARY_PAYMENT_JOURNALS = "salaryPaymentJournal/SALARY_PAYMENT_JOURNALS";
export const LOAD_SALARY_PAYMENT_JOURNALS = "salaryPaymentJournal/LOAD_SALARY_PAYMENT_JOURNALS";
export const LOAD_SALARY_PAYMENT_JOURNAL = "salaryPaymentJournal/LOAD_SALARY_PAYMENT_JOURNAL";
export const SALARY_PAYMENT_JOURNAL = "salaryPaymentJournal/SALARY_PAYMENT_JOURNAL";
export const MUTATE_SALARY_PAYMENT_JOURNALS = "salaryPaymentJournal/MUTATE_SALARY_PAYMENT_JOURNALS";
export const MUTATE_SALARY_PAYMENT_JOURNAL = "salaryPaymentJournal/MUTATE_SALARY_PAYMENT_JOURNAL";
export const SAVE_SALARY_PAYMENT_JOURNAL = "salaryPaymentJournal/SAVE_SALARY_PAYMENT_JOURNAL";
export const UPDATE_SALARY_PAYMENT_JOURNAL = "salaryPaymentJournal/UPDATE_SALARY_PAYMENT_JOURNAL";
export const DELETE_SALARY_PAYMENT_JOURNAL = "salaryPaymentJournal/DELETE_SALARY_PAYMENT_JOURNAL";
export const IS_SALARY_PAYMENT_JOURNALS_LOADING = "salaryPaymentJournal/IS_SALARY_PAYMENT_JOURNALS_LOADING";
export const MUTATE_IS_SALARY_PAYMENT_JOURNALS_LOADING = "salaryPaymentJournal/MUTATE_IS_SALARY_PAYMENT_JOURNALS_LOADING";
export const SET_IS_SALARY_PAYMENT_JOURNALS_LOADING = "salaryPaymentJournal/SET_IS_SALARY_PAYMENT_JOURNALS_LOADING";
export const LOAD_SALARY_PAYMENT_TYPES = "salaryPaymentJournal/LOAD_SALARY_PAYMENT_TYPES";
export const MUTATE_SALARY_PAYMENT_TYPES = "salaryPaymentJournal/MUTATE_SALARY_PAYMENT_TYPES";
export const SALARY_PAYMENT_TYPES = "salaryPaymentJournal/SALARY_PAYMENT_TYPES";
